    ...
    return (
        <footer className="d-flex flex-wrap justify-content-between align-items-center border-top">
            ...
            <div className="col-md-4 d-flex align-items-center">
                <span className="mb-3 mb-md-0 " style={{ paddingLeft: '1em' }}>© 2022 Steven Krenn</span>
            </div>

            <ul className="nav col-md-4 justify-content-end list-unstyled d-flex" style={{ paddingRight: '1em', display: "flex", flexDirection: "row" }}>
